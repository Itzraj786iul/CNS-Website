...
import { Breadcrumb } from "@/components/departments/breadcrumb";
...
function PageHero({ title, description }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden bg-background pb-16 pt-8 md:pb-20 md:pt-10">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-24 top-0 size-96 rounded-full bg-secondary/5 blur-3xl"
      />
