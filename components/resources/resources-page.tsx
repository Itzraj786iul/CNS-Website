    ...
    <>
      ...
      <CardGridSection
        ...
        heading={{
          ...
          description:
            "Complete these forms before your visit — save time at registration and help us serve you faster.",
        }}
      >
        {downloads.map((form) => (
          <CardGridItem key={form.title}>
            <ResourceCard
              variant="standard"
              title={form.title}
              type={form.type}
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              {insurance.points.map((point) => (
                <li
                  key={point}
                  className="flex gap-3 rounded-xl border border-cns-border/60 bg-card px-4 py-2.5 text-sm leading-relaxed text-cns-navy/85 shadow-soft"
                >
        ...
        <AnimatedSection>
          <div className="rounded-[20px] border border-cns-border/80 bg-card p-5 shadow-soft sm:p-6">
            <SectionHeading
              ...
              description="Help us maintain a calm, healing environment for every patient and family."
            />
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-2xl space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-heading text-2xl font-semibold text-cns-navy">
                    {emergency.title}
                  </h2>
                </div>
      ...
      <SplitContentSection
        ...
        left={
          <SectionHeading
            ...
            description="Practical answers about visits, medical records, insurance, and hospital policies at CNS."
          />
        }
        right={<FAQCard items={[...faq]} />}
      />
