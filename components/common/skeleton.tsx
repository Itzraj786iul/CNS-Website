...
function PageSkeleton() {
  return (
    <div className="flex flex-1 flex-col" aria-busy="true" aria-label="Loading page">
      <div className="brand-surface-page relative overflow-hidden pb-12 pt-8 sm:pb-14 sm:pt-10">
        <div
          aria-hidden="true"
          className="neural-pattern pointer-events-none absolute inset-0 opacity-20"
        />
        <div className="relative mx-auto w-full min-w-0 max-w-7xl px-4 sm:px-6 lg:px-10">
      ...
      <div className="section-surface-white py-12 md:py-16">
        <div className="mx-auto grid w-full min-w-0 max-w-7xl gap-5 px-4 sm:grid-cols-2 sm:gap-6 sm:px-6 lg:grid-cols-3 lg:px-10">
